function grava_config() {
    ...
    var pasta_ftp = document.getElementById('pasta_ftp').value;
    ...
    xmlhttpCfg.open("POST", "../controller/ajax_mercadolivre.php", true);
    xmlhttpCfg.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xmlhttpCfg.send("codigo_cliente=" + codigo_cliente + "&usuario=" + usuario + "&senha=" + senha + "&url=" + url + "&usuario_ftp=" + usuario_ftp + "&senha_ftp=" + senha_ftp + "&endereco_ftp=" + endereco_ftp + "&pasta_ftp=" + pasta_ftp + "&enviar_endereco=" + enviar_endereco);
