...
<html>
    <head>
        ...
        <script src="../controller/js/tique.js"></script>
    ...
    <body>
        <div id="conteudo">
            ...
            $por = json_decode(portal_carregar('TIQUE'));
            //
...
//            echo '    </tr>';
            echo '</table>';
            //
            $ret = json_decode(publicar_listar('TIQUE'));
            $tot = count($ret);
            ...
            echo '</h4>';
            if ($ret) {
                echo '<input type="buttton" value="Publicar" class="botao" onclick="window.open(\'../controller/tique.php\',\'_self\');">';
