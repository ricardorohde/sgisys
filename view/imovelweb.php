...
<html>
    <head>
        ...
        <script src="../controller/js/imovelweb.js"></script>
    ...
    <body>
        <div id="conteudo">
            ...
            $por = json_decode(portal_carregar('IMOVELWEB'));
            //
            ...
            echo '    </tr>';
            echo '    <tr>';
            echo '        <td bgcolor="#cccccc"><input type="text" name="codigo_cliente" id="codigo_cliente" size="15" value="' . $por->codigo_cliente . '" onchange="grava_config();"></td>';
            ...
            echo '    </tr>';
            echo '    <tr>';
            echo '        <td colspan="4" bgcolor="#cccccc">Enviar endereço do imóvel?</td>';
            echo '    </tr>';
            echo '    <tr>';
            ...
            echo '</table>';
            //
            $ret = json_decode(publicar_listar('IMOVELWEB'));
            $tot = count($ret);
            ...
            echo '</h4>';
            if ($ret) {
                echo '<input type="buttton" value="Publicar" class="botao" onclick="window.open(\'../controller/imovelweb.php\',\'_self\');">';
                ...
                foreach ($ret as $id) {
                    ...
                    echo '      <option ' . $sel3 . '>Especial</option>';
                    echo '  </select>';
                    echo ' </td>';
                    echo '</tr>';
                }
