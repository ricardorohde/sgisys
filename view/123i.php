...
<html>
    <head>
        ...
        <script src="../controller/js/123i.js"></script>
    </head>
    <body>
        <div id="conteudo">
            <?php
            include '../controller/portal.php';
            $por = json_decode(portal_carregar('123I'));
            //
            ...
            echo '</table>';
            //
            $ret = json_decode(publicar_listar('123I'));
            $tot = count($ret);
            ...
            echo '</h4>';
            if ($ret) {
                echo '<input type="buttton" value="Publicar" class="botao" onclick="window.open(\'../controller/123i.php\',\'_self\');">';
