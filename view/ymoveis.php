...
<html>
    <head>
        ...
        <script src="../controller/js/ymoveis.js"></script>
    ...
    <body>
        <div id="conteudo">
            ...
            $por = json_decode(portal_carregar('YMOVEIS'));
            //
...
//            echo '    </tr>';
            ...
            echo '</table>';
            //
            $ret = json_decode(publicar_listar('YMOVEIS'));
            $tot = count($ret);
            ...
            echo '</h4>';
            if ($ret) {
                echo '<input type="buttton" value="Publicar" class="botao" onclick="window.open(\'../controller/jau.php\',\'_self\');">';
