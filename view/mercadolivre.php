...
<html>
    <head>
        ...
        <script src="../controller/js/mercadolivre.js"></script>
    ...
    <body>
        <div id="conteudo">
            ...
            $por = json_decode(portal_carregar('MERCADOLIVRE'));
            //
            ...
            echo '    <tr>';
            echo '        <td colspan="5" bgcolor="#cccccc"><center>Configuração de Publicação</center></td>';
            echo '    </tr>';
            echo '    <tr>';
            echo '        <td bgcolor="#cccccc">E-mail Cliente</td>';
            echo '        <td bgcolor="#cccccc">URL Fotos</td>';
            echo '        <td bgcolor="#cccccc">Telefone (XXXX-XXXX)</td>';
            echo '    </tr>';
            echo '    <tr>';
            ...
            echo '        <td bgcolor="#cccccc"><input type="text" name="usuario" id="usuario" size="9" value="' . $por->usuario . '" onchange="grava_config();"></td>';
            echo '    </tr>';
            echo '    <tr>';
            echo '        <td bgcolor="#cccccc">Servidor FTP</td>';
            echo '        <td bgcolor="#cccccc">Usuario FTP</td>';
            echo '        <td bgcolor="#cccccc">Senha FTP</td>';
            echo '    </tr>';
            echo '    <tr>';
            ...
            echo '        <td bgcolor="#cccccc"><input type="text" name="usuario_ftp" id="usuario_ftp" size="20" value="' . $por->usuario_ftp . '" onchange="grava_config();"></td>';
            echo '        <td bgcolor="#cccccc"><input type="password" name="senha_ftp" id="senha_ftp" size="20" value="' . $por->senha_ftp . '" onchange="grava_config();"></td>';
            echo '    </tr>';
            ...
            echo '</table>';
            //
            $ret = json_decode(publicar_listar('MERCADOLIVRE'));
            $tot = count($ret);
            ...
            echo '</h4>';
            if ($ret) {
                echo '<input type="buttton" value="Publicar" class="botao" onclick="window.open(\'../controller/mercadolivre.php\',\'_self\');">';
                ...
                foreach ($ret as $id) {
                    ...
                    echo '      <option ' . $sel1 . '>silver</option>';
                    echo '      <option ' . $sel2 . '>gold</option>';
                    echo '      <option ' . $sel3 . '>gold_premium</option>';
                    echo '  </select>';
                    echo ' </td>';
                    echo '</tr>';
                }
