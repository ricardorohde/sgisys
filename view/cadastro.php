        ...
        <div id = "conteudo">
            <form action = "../controller/cadastro_grava.php" method = "POST" name = "form1" id = "form1" onsubmit = "return form_campos();">
                ...
                <div class="botoes-form" style="float:left;height:auto;">
                    ...
                    /*
                     * 
                      INSERT INTO `sgipl134_0002`.`tabela` (
                      `id` ,
                      `nome` ,
                      `campo` ,
                      `campo_nome` ,
                      ...
                      VALUES (
                      NULL , 'usuario_acesso', 'imovel_caracteristica', 'Característica do Imóvel', 'VARCHAR', '3', '3', '', '', 'Cadastro de Imóveis', 'Sim|Não', '', '', '', '', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '0000-00-00 00:00:00', ''
                      );

                     * 
                     * 
                     * 
                      ALTER TABLE `usuario_acesso` ADD `imovel_caracteristica` VARCHAR( 3 ) NOT NULL AFTER `imovel_excluir` ;
                     */
                ...
                if ($tipo_cadastro != 'imovel') {
                    ...
                    if ($corretor_id) {
                        ...
                        if ($corretor_restrito == 'Sim') {
                            if ($captado_venda_por != $corretor_nome && $captado_locacao_por != $corretor_nome) {
                                echo '<script>alert("Imóvel Restrito");</script>';
                                echo '<script>window.open("cadastros.php","_self");</script>';
                                exit();
                            }
                        }
                    }
                    if ($tipo_nome == 'Casas') {
                        ...
                        <br><input type = "text" name = "logradouro" id = "logradouro" size = "75" value = "' . $logradouro . '"></div>';
                            ...
                            //
                            echo ' <div class = "form2-varchar">Proprietário<br><input type = "text" name = "proprietario" id = "proprietario" size = "10" value = "' . $proprietario . '" ><img src="http://sgiplus.com.br/img/edit_add.png" onclick = "quadro_edita(\'proprietario\',\'proprietario\',document.getElementById(\'proprietario\').value);" title = "Clique para editar" style = "cursor: pointer;"></div>';
                        ...
                        <br><input type = "text" name = "logradouro" id = "logradouro" size = "75" value = "' . $logradouro . '"></div>';
                                            ...
                                            echo ' <input type = "text" list = "data_captado_venda_por" name = "captado_venda_por" id = "captado_venda_por" size = "30">';
                                            echo ' <datalist id = "data_captado_venda_por">';
                                            include '../model/conexao.php';
                                            $conexao = new conexao();
                                            ...
                                            echo ' <input type = "text" list = "data_captado_locacao_por" name = "captado_locacao_por" id = "captado_locacao_por" size = "30">';
                                            echo ' <datalist id = "data_captado_locacao_por">';
                                            include '../model/conexao.php';
                                            $conexao = new conexao();
                                            $ret = $conexao->db->query("SELECT nome FROM corretor ORDER BY nome");
                                            while ($row = $ret->fetch()) {
                                ...
                                <div class="envia-email" id="envia-email">
                                    ...
                                    <div class="form2-varchar"><b>E-mail de Envio</b>
                                        <br>
                                    ...
                                    <div class="form2-varchar"><b>Nome Cliente</b><br><input type="text" name="email_nome" id="email_nome" size="50"></div>
                                    <br><div class="form2-varchar"><b>E-mail Cliente</b><br><input type="text" name="email_para" id="email_para" size="50"></div>
                                    <br><br><div class="form2-textarea"><b>Mensagem</b><br><textarea name="email_mensagem" id="email_mensagem" rows="5" cols="60"></textarea></div>
